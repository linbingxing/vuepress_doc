...
<p class="codepen" data-height="300" data-theme-id="light" data-default-tab="js,result" data-user="linbingxing" data-slug-hash="YzXqNMO" style="height: 300px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="动态组件">
  <span>See the Pen <a href="https://codepen.io/linbingxing/pen/YzXqNMO">
  动态组件</a> by linbingxing (<a href="https://codepen.io/linbingxing">@linbingxing</a>)
